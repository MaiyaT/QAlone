...
//    [[UIButton alloc] initWithFrame:CGRectMake(0, CGRectGetHeight(self.view.frame) - kInputViewHeight, kAddImageButtonWidth, kInputViewHeight)];
    [self.addImageButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.view);
        make.width.mas_equalTo(kAddImageButtonWidth);
...
//    _sendButton.frame = CGRectMake(CGRectGetWidth(self.view.frame) - kSendButtonWidth, CGRectGetHeight(self.view.frame) - kInputViewHeight, kSendButtonWidth, kInputViewHeight);
    [self.sendButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.addImageButton);
        make.width.mas_equalTo(kSendButtonWidth);
        make.height.mas_equalTo(kInputViewHeight);
    }];
//    inputTextField = [[UITextField alloc] initWithFrame:CGRectMake(kAddImageButtonWidth, CGRectGetMinY(self.sendButton.frame), CGRectGetWidth(self.view.frame)- kSendButtonWidth - kAddImageButtonWidth, kInputViewHeight)];
    [self.inputTextField mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(self.addImageButton.mas_right);
...
- (void)keyboardWillShow:(NSNotification *)notification {
    ...
    [UIView animateWithDuration:animationDuration
                     ...
                     animations:^{
                         ...
                         CGFloat offsetY = CGRectGetHeight(self.view.frame) - CGRectGetMaxY(self.addImageButton.frame);
                         
                         self.addImageButton.transform = CGAffineTransformMakeTranslation(0, -keyboardHeight+offsetY);
                         self.inputTextField.transform = CGAffineTransformMakeTranslation(0, -keyboardHeight+offsetY);
                         self.sendButton.transform = CGAffineTransformMakeTranslation(0, -keyboardHeight+offsetY);
                         
                         self.tableView.contentInset = UIEdgeInsetsMake(0, 0, keyboardHeight+CGRectGetHeight(self.addImageButton.frame), 0);
                     }
...
- (void)keyboardWillHide:(NSNotification *)notification {
    ...
    self.inputTextField.transform = CGAffineTransformIdentity;
